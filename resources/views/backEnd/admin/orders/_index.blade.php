        ...
        <div class="dashboard-ecommerce">
            <div class="container-fluid dashboard-content ">
                ...
                <div class="row mb-3 order-card">
                            ...
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        ...
                                        <span class="percentage-badge">{{$total_order>0?number_format((($total_process_order/$total_order)*100)):0}}%</span>
                                    </div>
                            ...
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        ...
                                        <span class="percentage-badge">{{$total_order>0?number_format((($total_pending_delivery_order/$total_order)*100)):0}}%</span>
                                    </div>
                            ...
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        ...
                                        <span class="percentage-badge">{{$total_order>0?number_format((($total_pend_pay_order/$total_order)*100)):0}}%</span>
                                    </div>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.orders.status.on_delivery') : (Auth::guard('manager')->check() ? route('manager.orders.status.on_delivery') : (Auth::guard('employee')->check() ? route('employee.orders.status.on_delivery') : ""))}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        <h2 class="mb-0">{{$total_on_delivery_order}}</h2>
                                        <span class="percentage-badge">{{$total_order>0?number_format((($total_on_delivery_order/$total_order)*100)):0}}%</span>
                                    </div>
                            ...
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        ...
                                        <span class="percentage-badge">{{$total_order>0?number_format((($total_hold_order/$total_order)*100)):0}}%</span>
                                    </div>
                            ...
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        ...
                                        <span class="percentage-badge">{{$total_order>0?number_format((($total_cancel_order/$total_order)*100)):0}}%</span>
                                    </div>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.orders.status.return') : (Auth::guard('manager')->check() ? route('manager.orders.status.return') : (Auth::guard('employee')->check() ? route('employee.orders.status.return') : ""))}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        <h2 class="mb-0">{{$total_return_order}}</h2>
                                        <span class="percentage-badge">{{$total_order>0?number_format((($total_return_order/$total_order)*100)):0}}%</span>
                                    </div>
                            ...
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        ...
                                        <span class="percentage-badge">{{$total_order>0?number_format((($total_deliver_order/$total_order)*100)):0}}%</span>
                                    </div>
                                    ...
                                    @if(Auth::guard('admin')->check() || Auth::guard('manager')->check())
                                        @if($orders->count() > 0)
                                            @foreach($orders as $item)
                                                <?php
                                                $check_duplicate = \Illuminate\Support\Facades\DB::table('orders')->where([['customer_phone', $item->customer_phone], ['status', '!=', 1]])->count();
                                                ?>
                                                <tr id="tr_{{$item->id}}" class="{{$check_duplicate >1?"bg-danger-light":""}}">
                                                    ...
                                                    <td>
                                                        @if($item->courier_note)
                                                            <span class="text-dark"><b>C:</b> {{$item->courier_note}}</span>
                                                        @endif
                                                        @if($item->staff_note)
                                                            <br>
                                                            <span class="text-primary"><b>S:</b> {{$item->staff_note}}</span>
                                                        @endif
                                                    </td>
                                                    <td>
