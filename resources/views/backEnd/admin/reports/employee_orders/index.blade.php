            ...
            <div class="container-fluid dashboard-content ">
                        ...
                        <form action="" method="get">
                            ...
                            <div class="row">
                                <div class="col-2">
                                    <select name="emp_id" id="emp_id" class="form-control select2">
                                        ...
                                        @foreach ($employees as $key => $employee)
                                            <option value="{{ $key }}" {{ $key == $emp_id ? 'selected' : '' }}>
                                                {{ $employee }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-2">
                                    ...
                                    <a href="{{ route('admin.reports.employee_orders') }}"
                ...
                <div class="row mb-3 order-card">
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.employee_orders', 'emp_id=' . $emp_id . '&status=') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'emp_id=' . $emp_id . '&status=') : '') }}">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.employee_orders', 'emp_id=' . $emp_id . '&status=2') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'emp_id=' . $emp_id . '&status=2') : '') }}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.employee_orders', 'emp_id=' . $emp_id . '&status=9') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'emp_id=' . $emp_id . '&status=9') : '') }}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.employee_orders', 'emp_id=' . $emp_id . '&status=10') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'emp_id=' . $emp_id . '&status=10') : '') }}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.employee_orders', 'emp_id=' . $emp_id . '&status=0') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'emp_id=' . $emp_id . '&status=0') : '') }}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.employee_orders', 'emp_id=' . $emp_id . '&status=4') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'emp_id=' . $emp_id . '&status=4') : '') }}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.employee_orders', 'emp_id=' . $emp_id . '&status=3') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'emp_id=' . $emp_id . '&status=3') : '') }}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.employee_orders', 'emp_id=' . $emp_id . '&status=5') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'emp_id=' . $emp_id . '&status=5') : '') }}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.employee_orders', 'emp_id=' . $emp_id . '&status=6') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'emp_id=' . $emp_id . '&status=6') : '') }}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.employee_orders', 'emp_id=' . $emp_id . '&status=8') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'emp_id=' . $emp_id . '&status=8') : '') }}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.employee_orders', 'emp_id=' . $emp_id . '&status=7') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'emp_id=' . $emp_id . '&status=7') : '') }}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.employee_orders', 'emp_id=' . $emp_id . '&status=1') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'emp_id=' . $emp_id . '&status=1') : '') }}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
