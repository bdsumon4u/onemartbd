                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-12">
                                            ...
                                            <textarea name="customer_address" id="customer_address" class="form-control"
                                                      required>{{ $data->customer_address ?? null }}</textarea>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                                            ...
                                                            @foreach ($item->get_product->get_attributes as $key => $att)
                                                                ...
                                                                @foreach ($att->get_attribute_items as $key2 => $attr_item)
                                                                    <input type="radio"
                                                                           ...
                                                                           class="attr_checkbox"
                                                                           {{--                                                                           {{$item->attribute_ids?json_decode($item->attribute_ids, true)[$att->get_attribute->id]==$attr_item->get_attribute_item->id?'checked':"":($key2==0?'checked':"")}} required> --}}
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-12">
                                            <textarea name="courier_note" id="courier_note" class="form-control"
                                                      placeholder="Courier Note">{{ $data->courier_note }}</textarea>
                                        </div>
                                    </div>
