...
@php
    ...
    $total_nr_2_order = $data['total_nr_2_order'] ?? [];
...
@section('body')
            ...
            <div class="container-fluid dashboard-content ">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Orders By Product</h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Orders By Product</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                        ...
                        <form action="" method="get">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-12 mb-md-0 mb-2">
                                    <select name="prod_id" id="prod_id" class="form-control select2">
                                        <option value="">--Select Product--</option>
                                        @foreach($products as $key => $product)
                                            <option value="{{$key}}" {{$key==$prod_id?"selected":""}}>{{$product}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-2 col-12">
                                    ...
                                    <a href="{{route('admin.reports.orders_product')}}" class="btn btn-dark btn-sm">Reset</a>
                                </div>
                            </div>
                        </form>
                ...
                <div class="row mb-3 order-card">
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.orders_product','prod_id='.$prod_id.'&status=') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','prod_id='.$prod_id.'&status=') : "")}}">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.orders_product','prod_id='.$prod_id.'&status=2') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','prod_id='.$prod_id.'&status=2') : "")}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        <h2 class="mb-0">{{$total_process_order}}</h2>
                                        <span class="percentage-badge">{{$total_order>0?number_format((($total_process_order/$total_order)*100),2):0}}%</span>
                                    </div>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.orders_product','prod_id='.$prod_id.'&status=9') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','prod_id='.$prod_id.'&status=9') : "")}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        <h2 class="mb-0">{{$total_nr_1_order}}</h2>
                                        <span class="percentage-badge">{{$total_order>0?number_format((($total_nr_1_order/$total_order)*100),2):0}}%</span>
                                    </div>
                                    <h5 class="text-warning h5-s">Total No Response 1</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.orders_product','prod_id='.$prod_id.'&status=10') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','prod_id='.$prod_id.'&status=10') : "")}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        <h2 class="mb-0">{{$total_nr_2_order}}</h2>
                                        <span class="percentage-badge">{{$total_order>0?number_format((($total_nr_2_order/$total_order)*100),2):0}}%</span>
                                    </div>
                                    <h5 class="text-warning h5-s">Total No Response 2</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.orders_product','prod_id='.$prod_id.'&status=0') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','prod_id='.$prod_id.'&status=0') : "")}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        <h2 class="mb-0">{{$total_hold_order}}</h2>
                                        <span class="percentage-badge">{{$total_order>0?number_format((($total_hold_order/$total_order)*100),2):0}}%</span>
                                    </div>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.orders_product','prod_id='.$prod_id.'&status=4') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','prod_id='.$prod_id.'&status=4') : "")}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        <h2 class="mb-0">{{$total_cancel_order}}</h2>
                                        <span class="percentage-badge">{{$total_order>0?number_format((($total_cancel_order/$total_order)*100),2):0}}%</span>
                                    </div>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.orders_product','prod_id='.$prod_id.'&status=3') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','prod_id='.$prod_id.'&status=3') : "")}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        <h2 class="mb-0">{{$total_pend_pay_order}}</h2>
                                        <span class="percentage-badge">{{$total_order>0?number_format((($total_pend_pay_order/$total_order)*100),2):0}}%</span>
                                    </div>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.orders_product','prod_id='.$prod_id.'&status=5') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','prod_id='.$prod_id.'&status=5') : "")}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        <h2 class="mb-0">{{$total_pending_delivery_order}}</h2>
                                        <span class="percentage-badge">{{$total_order>0?number_format((($total_pending_delivery_order/$total_order)*100),2):0}}%</span>
                                    </div>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.orders_product','prod_id='.$prod_id.'&status=6') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','prod_id='.$prod_id.'&status=6') : "")}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        <h2 class="mb-0">{{$total_on_delivery_order}}</h2>
                                        <span class="percentage-badge">{{$total_order>0?number_format((($total_on_delivery_order/$total_order)*100),2):0}}%</span>
                                    </div>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.orders_product','prod_id='.$prod_id.'&status=8') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','prod_id='.$prod_id.'&status=8') : "")}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        <h2 class="mb-0">{{$total_courier_hold_order}}</h2>
                                        <span class="percentage-badge">{{$total_order>0?number_format((($total_courier_hold_order/$total_order)*100),2):0}}%</span>
                                    </div>
                                    <h5 class="text-warning h5-s">Total Courier Hold</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.orders_product','prod_id='.$prod_id.'&status=7') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','prod_id='.$prod_id.'&status=7') : "")}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        <h2 class="mb-0">{{$total_return_order}}</h2>
                                        <span class="percentage-badge">{{$total_order>0?number_format((($total_return_order/$total_order)*100),2):0}}%</span>
                                    </div>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.orders_product','prod_id='.$prod_id.'&status=1') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','prod_id='.$prod_id.'&status=1') : "")}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        <h2 class="mb-0">{{$total_deliver_order}}</h2>
                                        <span class="percentage-badge">{{$total_order>0?number_format((($total_deliver_order/$total_order)*100),2):0}}%</span>
                                    </div>
                    ...
                    <div class="row mb-2">
                        <div class="col-md-11 col-12 action_buttons">
                            ...
                            <form action="{{route('admin.orders.all.status')}}" method="post" id="all_status_form"
                                ...
                                <select name="status" id="status" class="form-control h-34">
                                    ...
                                    <option value="8">Courier Hold</option>
                                    <option value="9">No Response 1</option>
                                    <option value="10">No Response 2</option>
                                </select>
                            </form>

                            <form action="{{route('admin.orders.bulk.assign')}}" method="post" id="bulk_assign_form" class="mr-2">
                                @csrf
                            ...
                            <form action="{{route('admin.orders.courier_csv')}}" method="post" id="all_courier_csv" class="mr-2">
                                @csrf
                                <div class="form-group">
                            ...
                            <form action="{{route('admin.orders.bulk.label.print')}}" method="post" id="all_print_form"
                                  class="mr-2">
                                @csrf
                                <div class="form-group">
                                    <button type="button" id="bulk_label_print_btn" class="btn btn-warning btn-sm h-34">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-file-invoice" width="24" height="24"
                            ...
                            <form action="{{route('admin.orders.bulk.delete')}}" method="post" id="bulk_delete_form" class="mr-2">
                                @csrf
                                <div class="form-group">
                                    <input type="hidden" id="all_id" name="all_id">
                                    <button type="button" id="bulk_delete" class="btn btn-danger btn-sm h-34">Delete</button>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="col-md-1 col-12 action_buttons justify-content-end">
                            <form action="" method="get" id="paginate_form">
                                <input type="hidden" name="prod_id" value="{{request()->query('prod_id')}}">
                                <input type="hidden" name="status" value="{{$status ? $status : (request()->query('status')??null)}}">
                                <input type="hidden" name="query" value="{{request()->query('query')??null}}">
                                <input type="hidden" name="custom_range" value="{{request()->query('custom_range')??null}}">
                                <input type="hidden" name="start_date" value="{{request()->query('start_date')??null}}">
                                <input type="hidden" name="end_date" value="{{request()->query('end_date')??null}}">
                                <div class="form-group">
                ...
                @elseif(Auth::guard('manager')->check())
                    <div class="row mb-2">
                        <div class="col-md-11 col-12 action_buttons">
                            ...
                            <form action="{{route('manager.orders.bulk.assign')}}" method="post" id="bulk_assign_form" class="mr-2">
                                @csrf
                                <input type="hidden" id="all_order_id" name="all_order_id">
                                <select name="employee_id" id="employee_id" class="form-control h-34">
                                    <option value="">Select Employee</option>
                            ...
                            <form action="{{route('manager.orders.courier_csv')}}" method="post" id="all_courier_csv" class="mr-2">
                                @csrf
                                <div class="form-group">
                                    <input type="hidden" id="all_ord_id" name="all_ord_id">
                                    <select name="courier_csv" id="courier_csv" class="form-control h-34">
                            ...
                            <form action="{{route('manager.orders.bulk.label.print')}}" method="post" id="all_print_form"
                                  class="mr-2">
                                @csrf
                                <div class="form-group">
                                    <button type="button" id="bulk_label_print_btn" class="btn btn-warning btn-sm h-34">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body pb-0">
                                <div class="row">
                                    <div class="px-3 pt-2">Showing <span class="font-weight-bold text-danger">{{$count}}</span> results</div>
                                            ...
                                            @foreach($orders as $item)
                                                ...
                                                <tr id="tr_{{$item->id}}" class="{{$check_duplicate >1?"bg-danger-light":""}}">
                                                    ...
                                                    <td>
                                                        ...
                                                        @if($item->is_fake == 1)
                                                            <br>
                                                            <small class="badge badge-danger">Fake! <a href="{{route('admin.fake.remove',$item->id)}}"
                                                    ...
                                                    <td>
                                                        @foreach($item->get_products as $product)
                                                            {{$product->qty}} x <a target="_blank"
                                                                                   href="{{route('single.product',[$product->get_product->slug,$product->get_product->id])}}">{{$product->get_product->name}}</a>
                                                            <br>
                                                    ...
                                                    <td>
                                                        ...
                                                        @elseif($item->redx_tracking_id)
                                                            <a href="https://redx.com.bd/track-parcel/?trackingId={{$item->redx_tracking_id}}" target="_blank"><i
                                                                    class="fa fa-eye"></i></a>
                                                        @endif
                                                        ...
                                                        @if(Auth::guard('admin')->check())
                                                            <div class="dropdown-menu">
                                                                ...
                                                                <a class="dropdown-item {{$item->status==10?"d-none":""}}"
                                                                   href="{{Auth::guard('admin')->check() ? route('admin.orders.status',[$item->id,10]) : (Auth::guard('manager')->check() ? route('manager.orders.status',[$item->id,10]) : "")}}">No
                                                                    Response 2</a>
                                                            </div>
                                                        @elseif(Auth::guard('manager')->check())
                                                            @if($item->status==5)
                                                    ...
                                                    <td>
                                                        <i class="fa fa-edit note_btn" data-id="{{$item->id}}" data-type="courier" data-note="{{$item->courier_note}}"
                                                           style="cursor: pointer"></i> <span class="text-dark"><b>C:</b> {{$item->courier_note}}</span>
                                                        <br>
                                                        <i class="fa fa-edit note_btn" data-id="{{$item->id}}" data-type="staff" data-note="{{$item->staff_note}}"
                                                           style="cursor: pointer"></i> <span class="text-primary"><b>S:</b> {{$item->staff_note}}</span>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @if(Auth::guard('admin')->check())
                                                            ...
                                                            <a href="javascript:void(0)" class="d-block mb-1 transaction_btn" data-id="{{$item->id}}">
                                        ...
                                        @if($orders->count() > 0)
                                            @foreach($orders as $item)
                                                ...
                                                <tr id="tr_{{$item->id}}" class="{{$check_duplicate>1?"bg-danger-light":""}}">
                                                    ...
                                                    <td>
                                                        {{$web_settings->currency_sign}} {{$item->total}}<br>
                                                        <span class="text-success">P:-{{$item->paid}}</span><br>
                                                        <span class="text-danger">D:-{{$item->due}}</span>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @elseif($item->status!=6&&$item->status!=1&&$item->status!=7)
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item {{$item->status==0?"d-none":""}}"
                                                                   href="{{route('employee.orders.status',[$item->id,0])}}">On Hold</a>
                                                                <a class="dropdown-item {{$item->status==2?"d-none":""}}"
                                                                ...
                                                                <a class="dropdown-item {{$item->status==4?"d-none":""}}"
                                                                   href="{{route('employee.orders.status',[$item->id,4])}}">Canceled</a>
                                                                <a class="dropdown-item {{$item->status==5?"d-none":""}}"
                                                                   href="{{route('employee.orders.status',[$item->id,5])}}">Pending Delivery</a>
                                                                {{--<a class="dropdown-item {{$item->status==6?"d-none":""}}"
                                                                   href="{{route('employee.orders.status',[$item->id,6])}}">On Delivery</a>--}}
                                                                <a class="dropdown-item {{$item->status==9?"d-none":""}}"
                                                                   href="{{route('employee.orders.status',[$item->id,9])}}">No Response 1</a>
                                                                <a class="dropdown-item {{$item->status==10?"d-none":""}}"
                                                                   href="{{route('employee.orders.status',[$item->id,10])}}">No Response 2</a>
                                                            </div>
                                                        @endif
                                                    </td>
                                                    <td>
    ...
    <div class="modal fade" id="transaction_view" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
