                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 p-2">
                                <div class="card border shadow-sm h-100">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox"
                                                    ...
                                                    name="smsSettings[{{ $setting->id }}][active]" value="1"
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox"
                                                    ...
                                                    name="smsSettings[{{ $setting->id }}][wp_active]" value="1"
                                        ...
                                        <div>
                                            <textarea name="smsSettings[{{ $setting->id }}][message]" class="form-control form-control-sm" rows="3"
