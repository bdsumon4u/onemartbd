                            ...
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        ...
                                        <span
                                            class="percentage-badge">{{ $total_order > 0 ? number_format(($total_process_orders / $total_order) * 100) : 0 }}%</span>
                                    </div>
                            ...
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        ...
                                        <span
                                            class="percentage-badge">{{ $total_order > 0 ? number_format(($total_pending_delivery_orders / $total_order) * 100) : 0 }}%</span>
                                    </div>
                            ...
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        ...
                                        <span
                                            class="percentage-badge">{{ $total_order > 0 ? number_format(($total_pend_pay_orders / $total_order) * 100) : 0 }}%</span>
                                    </div>
                            ...
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        ...
                                        <span
                                            class="percentage-badge">{{ $total_order > 0 ? number_format(($total_on_delivery_orders / $total_order) * 100) : 0 }}%</span>
                                    </div>
                            ...
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        ...
                                        <span
                                            class="percentage-badge">{{ $total_order > 0 ? number_format(($total_hold_orders / $total_order) * 100) : 0 }}%</span>
                                    </div>
                            ...
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        ...
                                        <span
                                            class="percentage-badge">{{ $total_order > 0 ? number_format(($total_cancel_orders / $total_order) * 100) : 0 }}%</span>
                                    </div>
                            ...
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        ...
                                        <span
                                            class="percentage-badge">{{ $total_order > 0 ? number_format(($total_return_orders / $total_order) * 100) : 0 }}%</span>
                                    </div>
                            ...
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        ...
                                        <span
                                            class="percentage-badge">{{ $total_order > 0 ? number_format(($total_deliver_orders / $total_order) * 100) : 0 }}%</span>
                                    </div>
