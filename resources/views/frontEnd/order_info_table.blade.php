        ...
        @foreach (\Cart::getContent()->sort() as $item)
            <tr>
                ...
                <td width="15%" class="cart_qty">
                    <a href="javascript:void(0);"><i class="fa fa-minus qty_minus" id=""
                            data-id="{{ $item->id }}"></i></a>
                    <input type="text" name="qty" id="qty" min="1" value="{{ $item->quantity }}"
                        readonly>
                    <a href="javascript:void(0);"><i class="fa fa-plus qty_plus" id=""
                            data-id="{{ $item->id }}"></i></a>
                </td>
