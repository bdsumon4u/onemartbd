                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="store_id" id="store_id" value="{{$data->store_id ?? null}}">
                                    </div>

                                    <div class="form-group">
                                        <label for="email">Email</label>
                                        <input type="text" class="form-control" name="email" id="email" value="{{$data->email ?? null}}">
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control form-control-textarea" name="access_token" id="access_token" rows="5"
                                                  disabled>{!! $data->access_token ?? null !!}</textarea>
                                    </div>
