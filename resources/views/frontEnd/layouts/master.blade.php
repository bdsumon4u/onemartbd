...
@if($hasWhatsapp && $hasMessenger)
    <div class="floating-contact">
        <button class="fab-btn" id="contactToggle" type="button" aria-label="Open chat options">
            <svg id="fabIcon" width="32" height="32" viewBox="0 0 32 32" aria-hidden="true" focusable="false">
                <path fill="#ffffff"
                      d="M8 9c-2.21 0-4 1.66-4 3.7v5.1C4 19.94 5.79 21.6 8 21.6h4.3v2.35c0 .9.98 1.42 1.68.9L18 21.6h6c2.21 0 4-1.66 4-3.7v-5.1C28 10.66 26.21 9 24 9Z"/>
            </svg>
        </button>
