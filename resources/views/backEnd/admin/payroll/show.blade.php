                    ...
                    <div class="card-body p-0">
                        <table class="table table-sm mb-0">
                            ...
                            <tr>
                                ...
                                <td class="text-right pr-3 text-success">{{ $fmt($payroll->occasional_bonus_amount) }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="pr-3 text-right">
                                    <span class="badge badge-{{ $statusBadge }}">{{ ucfirst($payroll->status) }}</span>
                    ...
                    <table class="table table-sm table-bordered mb-0">
                        ...
                        <tbody>
                            @foreach ($attendances as $att)
                                @php
                                    $overtimeUnits = $overtimeUnitMin > 0 ? floor($att->overtime_minutes / $overtimeUnitMin) : 0;
                                    $overtimePay   = $overtimeUnits * (float) $settings->overtime_rate;
                                    $lateUnits     = $latetimeUnitMin > 0 ? floor($att->late_minutes / $latetimeUnitMin) : 0;
                                ...
                                <tr>
                                    ...
                                    <td class="text-center {{ (float) ($att->penalty_amount ?? 0) > 0 ? 'text-danger' : '' }}">
