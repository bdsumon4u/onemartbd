...
@php
    ...
    $total_nr_2_orders = $data['total_nr_2_orders'] ?? [];
            ...
            <div class="container-fluid dashboard-content ">
                        ...
                        <form action="" method="get">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-12 mb-md-0 mb-2">
                                    <select name="prod_id" id="prod_id" class="form-control select2">
                                        ...
                                        @foreach ($products as $key => $product)
                                            <option value="{{ $key }}" {{ $key == $prod_id ? 'selected' : '' }}>
                                                {{ $product }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-2 col-12">
                                    ...
                                    <a href="{{ route('admin.reports.orders_product') }}"
                ...
                <div class="row mb-3 order-card">
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.orders_product', 'prod_id=' . $prod_id . '&status=') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'prod_id=' . $prod_id . '&status=') : '') }}">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.orders_product', 'prod_id=' . $prod_id . '&status=2') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'prod_id=' . $prod_id . '&status=2') : '') }}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.orders_product', 'prod_id=' . $prod_id . '&status=9') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'prod_id=' . $prod_id . '&status=9') : '') }}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.orders_product', 'prod_id=' . $prod_id . '&status=10') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'prod_id=' . $prod_id . '&status=10') : '') }}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        <h2 class="mb-0">{{ $total_nr_2_orders }}</h2>
                                        <span
                                            class="percentage-badge">{{ $total_order > 0 ? number_format(($total_nr_2_orders / $total_order) * 100, 2) : 0 }}%</span>
                                    </div>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.orders_product', 'prod_id=' . $prod_id . '&status=0') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'prod_id=' . $prod_id . '&status=0') : '') }}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.orders_product', 'prod_id=' . $prod_id . '&status=4') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'prod_id=' . $prod_id . '&status=4') : '') }}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.orders_product', 'prod_id=' . $prod_id . '&status=3') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'prod_id=' . $prod_id . '&status=3') : '') }}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.orders_product', 'prod_id=' . $prod_id . '&status=5') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'prod_id=' . $prod_id . '&status=5') : '') }}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        <h2 class="mb-0">{{ $total_pending_delivery_orders }}</h2>
                                        <span
                                            class="percentage-badge">{{ $total_order > 0 ? number_format(($total_pending_delivery_orders / $total_order) * 100, 2) : 0 }}%</span>
                                    </div>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.orders_product', 'prod_id=' . $prod_id . '&status=6') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'prod_id=' . $prod_id . '&status=6') : '') }}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.orders_product', 'prod_id=' . $prod_id . '&status=8') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'prod_id=' . $prod_id . '&status=8') : '') }}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.orders_product', 'prod_id=' . $prod_id . '&status=7') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'prod_id=' . $prod_id . '&status=7') : '') }}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a
                            href="{{ Auth::guard('admin')->check() ? route('admin.reports.orders_product', 'prod_id=' . $prod_id . '&status=1') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders', 'prod_id=' . $prod_id . '&status=1') : '') }}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                   ...
                                                                   href="{{route('employee.orders.status',[$item->id,6])}}">On Delivery</a> --}}
                                                                    <a class="dropdown-item {{ $item->status == 9 ? 'd-none' : '' }}"
                                                                        ...
                                                                        Response 1</a>
                                                                    <a class="dropdown-item {{ $item->status == 10 ? 'd-none' : '' }}"
                                                                        href="{{ route('employee.orders.status', [$item->id, 10]) }}">No
                                                                        Response 2</a>
                                                                </div>
                                                            @endif
                                                        </td>
