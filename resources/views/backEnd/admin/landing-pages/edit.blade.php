                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        ...
                                        <option value="0" {{ !$landingPage->status ? 'selected' : '' }}>Inactive
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-12"
                                        ...
                                        @if (count($landingPage->gallery_images_array) > 0)
                                            <div class="mb-2">
                                                @foreach ($landingPage->gallery_images_array as $image)
                                                    <img width="80" src="{{ $image }}" alt="Gallery Image"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-muted">
                                            Upload new images to replace current gallery. If no images are uploaded,
                                            existing gallery will be preserved.
