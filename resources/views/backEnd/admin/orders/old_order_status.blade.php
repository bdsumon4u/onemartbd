                            ...
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        ...
                                        <span class="percentage-badge">{{number_format((($total_process_order/$total_order)*100))}}%</span>
                                    </div>
                            ...
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        ...
                                        <span class="percentage-badge">{{number_format((($total_pending_delivery_order/$total_order)*100))}}%</span>
                                    </div>
                            ...
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        ...
                                        <span class="percentage-badge">{{number_format((($total_pend_pay_order/$total_order)*100))}}%</span>
                                    </div>
                            ...
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        ...
                                        <span class="percentage-badge">{{number_format((($total_on_delivery_order/$total_order)*100))}}%</span>
                                    </div>
                            ...
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        ...
                                        <span class="percentage-badge">{{number_format((($total_hold_order/$total_order)*100))}}%</span>
                                    </div>
                            ...
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        ...
                                        <span class="percentage-badge">{{number_format((($total_cancel_order/$total_order)*100))}}%</span>
                                    </div>
                            ...
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        ...
                                        <span class="percentage-badge">{{number_format((($total_return_order/$total_order)*100))}}%</span>
                                    </div>
                            ...
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                                        ...
                                        <span class="percentage-badge">{{number_format((($total_deliver_order/$total_order)*100))}}%</span>
                                    </div>
