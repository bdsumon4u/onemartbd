            ...
            <div class="container-fluid dashboard-content ">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Employee Orders</h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Employee Orders</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row mb-3 order-card">
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.employee_orders','emp_id='.$emp_id.'&status=') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','emp_id='.$emp_id.'&status=') : "")}}">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.employee_orders','emp_id='.$emp_id.'&status=2') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','emp_id='.$emp_id.'&status=2') : "")}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.employee_orders','emp_id='.$emp_id.'&status=9') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','emp_id='.$emp_id.'&status=9') : "")}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.employee_orders','emp_id='.$emp_id.'&status=10') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','emp_id='.$emp_id.'&status=10') : "")}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.employee_orders','emp_id='.$emp_id.'&status=0') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','emp_id='.$emp_id.'&status=0') : "")}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.employee_orders','emp_id='.$emp_id.'&status=4') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','emp_id='.$emp_id.'&status=4') : "")}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.employee_orders','emp_id='.$emp_id.'&status=3') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','emp_id='.$emp_id.'&status=3') : "")}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.employee_orders','emp_id='.$emp_id.'&status=5') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','emp_id='.$emp_id.'&status=5') : "")}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.employee_orders','emp_id='.$emp_id.'&status=6') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','emp_id='.$emp_id.'&status=6') : "")}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.employee_orders','emp_id='.$emp_id.'&status=8') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','emp_id='.$emp_id.'&status=8') : "")}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.employee_orders','emp_id='.$emp_id.'&status=7') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','emp_id='.$emp_id.'&status=7') : "")}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 mb-md-4 mb-3">
                        <a href="{{Auth::guard('admin')->check() ? route('admin.reports.employee_orders','emp_id='.$emp_id.'&status=1') : (Auth::guard('manager')->check() ? route('manager.reports.employee_orders','emp_id='.$emp_id.'&status=1') : "")}}">
                            <div class="card border-3">
                                <div class="card-body">
                                    <div class="metric-value d-inline-block">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-1 col-12 action_buttons justify-content-end">
                            <form action="" method="get" id="paginate_form">
                                <input type="hidden" name="emp_id" value="{{request()->query('emp_id')??null}}">
                                <input type="hidden" name="status" value="{{$status ? $status : (request()->query('status')??null)}}">
                                <input type="hidden" name="query" value="{{request()->query('query')??null}}">
