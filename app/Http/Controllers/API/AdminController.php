...
class AdminController extends Controller
{
    public function dashboard(Request $request)
    {
        ...
        if ($request->input('role_id') == 1 || $request->input('role_id') == 2 || $request->input('role_id') == 3) {
            $data['total_revenue'] = DB::table('orders')->whereBetween('created_at', [Carbon::now()->subDays(7), Carbon::now()])->where('status', 1)->sum('total');
            $data['total_customer'] = DB::table('users')->whereBetween('created_at', [Carbon::now()->subDays(7), Carbon::now()])->count();
            ...
            /*$data['recent_orders'] = DB::table('orders')->select('id', 'order_date', 'customer_name', 'customer_phone', 'total', 'status')
                ...
                ->limit(10)
                ->get();*/
            $data['total_orders'] = DB::table('orders')->whereBetween('created_at', [Carbon::now()->subDays(3), Carbon::now()])->count();
            $data['total_hold_orders'] = DB::table('orders')->whereBetween('created_at', [Carbon::now()->subDays(7), Carbon::now()])->where('status', 0)->count();
            $data['total_deliver_orders'] = DB::table('orders')->whereBetween('created_at', [Carbon::now()->subDays(2), Carbon::now()])->where('status', 1)->count();
            $data['total_process_orders'] = DB::table('orders')->whereBetween('created_at', [Carbon::now()->subDays(7), Carbon::now()])->where('status', 2)->count();
            $data['total_pend_pay_orders'] = DB::table('orders')->whereBetween('created_at', [Carbon::now()->subDays(7), Carbon::now()])->where('status', 3)->count();
            $data['total_cancel_orders'] = DB::table('orders')->whereBetween('created_at', [Carbon::now()->subDays(2), Carbon::now()])->where('status', 4)->count();
            $data['total_pending_delivery_orders'] = DB::table('orders')->whereBetween('created_at', [Carbon::now()->subDays(3), Carbon::now()])->where('status', 5)->count();
            $data['total_on_delivery_orders'] = DB::table('orders')->whereBetween('created_at', [Carbon::now()->subDays(3), Carbon::now()])->where('status', 6)->count();
            $data['total_return_orders'] = DB::table('orders')->whereBetween('created_at', [Carbon::now()->subDays(7), Carbon::now()])->where('status', 7)->count();
            $data['total_courier_hold_orders'] = DB::table('orders')->whereBetween('created_at', [Carbon::now()->subDays(7), Carbon::now()])->where('status', 8)->count();
            $data['total_nr_1_orders'] = DB::table('orders')->whereBetween('created_at', [Carbon::now()->subDays(7), Carbon::now()])->where('status', 9)->count();
            $data['total_nr_2_orders'] = DB::table('orders')->whereBetween('created_at', [Carbon::now()->subDays(7), Carbon::now()])->where('status', 10)->count();

            $data['today_orders'] = DB::table('orders')->whereDate('order_date', Carbon::today())
                ->count();
