...
class WebSettings extends Model
{
    ...
    protected $fillable = [
        ...
        'is_order_confirm_sms', 'order_confirm_sms', 'order_custom_sms', 'is_sms_enabled', 'sms_start_time', 'sms_end_time',
        'api_access_token', 'fb_pixel_id',
        ...
        'order_defender_blocked_utm_sources',
