                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="store_id" id="store_id" value="{{$data->store_id ?? null}}">
                                    </div>

                                    <div class="form-group">
                                        <label for="client_id">Client ID</label>
                                        <input class="form-control" type="text" name="client_id" id="client_id" value="{{$data->client_id ?? null}}">
                                    </div>

                                    <div class="form-group">
                                        <label for="client_secret">Client Secret</label>
                                        <input type="text" class="form-control" name="client_secret" id="client_secret" value="{{$data->client_secret ?? null}}">
                                    </div>

                                    <div class="form-group">
                                        <label for="username">Email</label>
                                        <input type="text" class="form-control" name="username" id="username" value="{{$data->username ?? null}}">
                                    </div>

                                    <div class="form-group">
                                        <label for="password">Password</label>
                                        <input type="text" class="form-control" name="password" id="password" value="{{$data->password ?? null}}">
                                    </div>
