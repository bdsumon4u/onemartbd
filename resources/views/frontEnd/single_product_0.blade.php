                        ...
                        <h3 class="font-weight-bold single_prod_prices">
                            @if ($data->sale_price > 0)
                                <span class="old_price"
                                    ...
                                    {{ $data->price }}</span>
                                <span style="color: #c9151b">{{ $web_settings->currency_sign }}
                                ...
                                @foreach ($data->get_attributes as $att)
                                    <div class="row mb-2">
                                        <div class="col-md-6 col-12">
                                            ...
                                            <select name="attribute_item_id[]" id=""
                                                class="form-control attribute_item_id">
                                                @foreach ($att->get_attribute_items as $attr_item)
                                                    <option value="{{ $attr_item->get_attribute_item->id }}">
                                                        {{ $attr_item->get_attribute_item->item_title }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
